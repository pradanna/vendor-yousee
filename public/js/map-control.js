...
function generateDetail(data) {
  ...
  $("#detail-gambar-3").attr("src", data["image1"]);
  $("#link-gbr1").attr("href", data["image1"]);
  $("#dwnld-gbr1").attr("href", data["image1"]);
  $("#dwnld-gbr1").attr("download", data["image1"]);
  $("#link-gbr2").attr("href", data["image1"]);
  $("#dwnld-gbr2").attr("href", data["image1"]);
  $("#dwnld-gbr2").attr("download", data["image1"]);
  $("#link-gbr3").attr("href", data["image1"]);
  $("#dwnld-gbr3").attr("href", data["image1"]);
  $("#dwnld-gbr3").attr("download", data["image1"]);
}
