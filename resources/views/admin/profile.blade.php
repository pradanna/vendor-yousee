            ...
            <div class="menu">
                ...
                <form method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="p-brand" name="p-brand" placeholder="Brand" value="{{ $data->brand }}">
                                <label for="p-brand" class="form-label">Brand</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="p-alamat" name="p-alamat" placeholder="alamat" value="{{ $data->address }}">
                        <label for="p-alamat" class="form-label">Alamat</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="p-email" name="p-email" placeholder="email" value="{{ $data->email }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="p-pic" name="p-pic" placeholder="Nama PIC" value="{{ $data->picName }}">
